...
/**
 * Performance test for the Culture entity.
 */
class CultureGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Culture entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all cultures")
            .get("/services/vscommerce/api/cultures")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new culture")
            .post("/services/vscommerce/api/cultures")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created culture")
                .get("/services/vscommerce${new_culture_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created culture")
            .delete("/services/vscommerce${new_culture_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
