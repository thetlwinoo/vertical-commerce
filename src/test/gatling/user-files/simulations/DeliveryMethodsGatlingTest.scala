...
class DeliveryMethodsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DeliveryMethods entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/delivery-methods")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new deliveryMethods")
            .post("/services/vscommerce/api/delivery-methods")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_deliveryMethods_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created deliveryMethods")
            .delete("/services/vscommerce${new_deliveryMethods_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
