...
class StockItemTransactionsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StockItemTransactions entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/stock-item-transactions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new stockItemTransactions")
            .post("/services/vscommerce/api/stock-item-transactions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_stockItemTransactions_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created stockItemTransactions")
            .delete("/services/vscommerce${new_stockItemTransactions_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
