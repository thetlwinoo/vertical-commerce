...
class UnitMeasureGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the UnitMeasure entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/unit-measures")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new unitMeasure")
            .post("/services/vscommerce/api/unit-measures")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_unitMeasure_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created unitMeasure")
            .delete("/services/vscommerce${new_unitMeasure_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
