...
class ProductCategoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProductCategory entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/product-categories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new productCategory")
            .post("/services/vscommerce/api/product-categories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_productCategory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created productCategory")
            .delete("/services/vscommerce${new_productCategory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
