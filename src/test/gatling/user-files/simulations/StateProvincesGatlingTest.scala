...
class StateProvincesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StateProvinces entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/state-provinces")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new stateProvinces")
            .post("/services/vscommerce/api/state-provinces")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_stateProvinces_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created stateProvinces")
            .delete("/services/vscommerce${new_stateProvinces_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
