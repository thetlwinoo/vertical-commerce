...
class CampaignGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Campaign entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/campaigns")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new campaign")
            .post("/services/vscommerce/api/campaigns")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_campaign_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created campaign")
            .delete("/services/vscommerce${new_campaign_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
