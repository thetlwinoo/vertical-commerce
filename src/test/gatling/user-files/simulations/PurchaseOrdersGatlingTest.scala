...
class PurchaseOrdersGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PurchaseOrders entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/purchase-orders")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new purchaseOrders")
            .post("/services/vscommerce/api/purchase-orders")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_purchaseOrders_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created purchaseOrders")
            .delete("/services/vscommerce${new_purchaseOrders_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
