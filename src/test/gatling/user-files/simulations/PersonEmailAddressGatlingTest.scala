...
/**
 * Performance test for the PersonEmailAddress entity.
 */
class PersonEmailAddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PersonEmailAddress entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all personEmailAddresses")
            .get("/services/vscommerce/api/person-email-addresses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new personEmailAddress")
            .post("/services/vscommerce/api/person-email-addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created personEmailAddress")
                .get("/services/vscommerce${new_personEmailAddress_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created personEmailAddress")
            .delete("/services/vscommerce${new_personEmailAddress_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
