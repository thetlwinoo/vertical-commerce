...
/**
 * Performance test for the ProductOptionSet entity.
 */
class ProductOptionSetGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProductOptionSet entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all productOptionSets")
            .get("/services/vscommerce/api/product-option-sets")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new productOptionSet")
            .post("/services/vscommerce/api/product-option-sets")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "value":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created productOptionSet")
                .get("/services/vscommerce${new_productOptionSet_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created productOptionSet")
            .delete("/services/vscommerce${new_productOptionSet_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
