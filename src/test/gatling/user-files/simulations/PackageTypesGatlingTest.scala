...
class PackageTypesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PackageTypes entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/package-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new packageTypes")
            .post("/services/vscommerce/api/package-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_packageTypes_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created packageTypes")
            .delete("/services/vscommerce${new_packageTypes_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
