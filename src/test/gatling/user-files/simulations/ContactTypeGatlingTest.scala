...
/**
 * Performance test for the ContactType entity.
 */
class ContactTypeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ContactType entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all contactTypes")
            .get("/services/vscommerce/api/contact-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new contactType")
            .post("/services/vscommerce/api/contact-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created contactType")
                .get("/services/vscommerce${new_contactType_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created contactType")
            .delete("/services/vscommerce${new_contactType_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
