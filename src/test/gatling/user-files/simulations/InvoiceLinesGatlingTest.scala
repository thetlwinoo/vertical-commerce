...
class InvoiceLinesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoiceLines entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/invoice-lines")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoiceLines")
            .post("/services/vscommerce/api/invoice-lines")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_invoiceLines_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoiceLines")
            .delete("/services/vscommerce${new_invoiceLines_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
