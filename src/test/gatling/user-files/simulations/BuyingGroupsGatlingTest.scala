...
class BuyingGroupsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BuyingGroups entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/buying-groups")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new buyingGroups")
            .post("/services/vscommerce/api/buying-groups")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_buyingGroups_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created buyingGroups")
            .delete("/services/vscommerce${new_buyingGroups_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
