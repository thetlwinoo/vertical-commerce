...
class ProductsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Products entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/products")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new products")
            .post("/services/vscommerce/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_products_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created products")
            .delete("/services/vscommerce${new_products_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
