...
class SpecialDealsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SpecialDeals entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/special-deals")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new specialDeals")
            .post("/services/vscommerce/api/special-deals")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_specialDeals_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created specialDeals")
            .delete("/services/vscommerce${new_specialDeals_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
