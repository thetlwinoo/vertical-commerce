...
class QuestionsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Questions entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/questions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new questions")
            .post("/services/vscommerce/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_questions_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created questions")
            .delete("/services/vscommerce${new_questions_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
