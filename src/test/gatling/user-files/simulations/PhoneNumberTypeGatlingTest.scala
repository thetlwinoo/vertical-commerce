...
/**
 * Performance test for the PhoneNumberType entity.
 */
class PhoneNumberTypeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PhoneNumberType entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all phoneNumberTypes")
            .get("/services/vscommerce/api/phone-number-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new phoneNumberType")
            .post("/services/vscommerce/api/phone-number-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created phoneNumberType")
                .get("/services/vscommerce${new_phoneNumberType_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created phoneNumberType")
            .delete("/services/vscommerce${new_phoneNumberType_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
