...
class CountriesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Countries entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/countries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new countries")
            .post("/services/vscommerce/api/countries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_countries_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created countries")
            .delete("/services/vscommerce${new_countries_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
