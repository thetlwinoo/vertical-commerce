...
class SuppliersGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Suppliers entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/suppliers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new suppliers")
            .post("/services/vscommerce/api/suppliers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_suppliers_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created suppliers")
            .delete("/services/vscommerce${new_suppliers_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
