...
/**
 * Performance test for the Addresses entity.
 */
class AddressesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Addresses entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/addresses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new addresses")
            .post("/services/vscommerce/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created addresses")
                .get("/services/vscommerce${new_addresses_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created addresses")
            .delete("/services/vscommerce${new_addresses_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
