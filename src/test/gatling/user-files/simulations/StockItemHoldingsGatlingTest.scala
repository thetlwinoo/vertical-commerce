...
class StockItemHoldingsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StockItemHoldings entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/stock-item-holdings")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new stockItemHoldings")
            .post("/services/vscommerce/api/stock-item-holdings")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "quantityOnHand":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_stockItemHoldings_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created stockItemHoldings")
            .delete("/services/vscommerce${new_stockItemHoldings_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
