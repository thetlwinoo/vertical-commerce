...
class CurrencyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Currency entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/currencies")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new currency")
            .post("/services/vscommerce/api/currencies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_currency_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created currency")
            .delete("/services/vscommerce${new_currency_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
