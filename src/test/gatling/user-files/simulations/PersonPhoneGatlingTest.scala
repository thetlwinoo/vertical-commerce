...
/**
 * Performance test for the PersonPhone entity.
 */
class PersonPhoneGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PersonPhone entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all personPhones")
            .get("/services/vscommerce/api/person-phones")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new personPhone")
            .post("/services/vscommerce/api/person-phones")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created personPhone")
                .get("/services/vscommerce${new_personPhone_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created personPhone")
            .delete("/services/vscommerce${new_personPhone_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
