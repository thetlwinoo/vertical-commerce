...
class StockItemsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StockItems entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/stock-items")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new stockItems")
            .post("/services/vscommerce/api/stock-items")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_stockItems_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created stockItems")
            .delete("/services/vscommerce${new_stockItems_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
