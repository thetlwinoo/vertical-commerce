...
class OrderLinesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the OrderLines entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/order-lines")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new orderLines")
            .post("/services/vscommerce/api/order-lines")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "quantity":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_orderLines_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created orderLines")
            .delete("/services/vscommerce${new_orderLines_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
