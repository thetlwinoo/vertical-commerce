...
class CurrencyRateGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CurrencyRate entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/currency-rates")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new currencyRate")
            .post("/services/vscommerce/api/currency-rates")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_currencyRate_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created currencyRate")
            .delete("/services/vscommerce${new_currencyRate_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
