...
/**
 * Performance test for the Materials entity.
 */
class MaterialsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Materials entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/materials")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new materials")
            .post("/services/vscommerce/api/materials")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created materials")
                .get("/services/vscommerce${new_materials_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created materials")
            .delete("/services/vscommerce${new_materials_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
