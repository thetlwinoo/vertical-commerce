...
class CustomersGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customers entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/customers")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new customers")
            .post("/services/vscommerce/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_customers_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created customers")
            .delete("/services/vscommerce${new_customers_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
