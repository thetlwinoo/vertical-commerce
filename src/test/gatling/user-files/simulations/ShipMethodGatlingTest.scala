...
/**
 * Performance test for the ShipMethod entity.
 */
class ShipMethodGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ShipMethod entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all shipMethods")
            .get("/services/vscommerce/api/ship-methods")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new shipMethod")
            .post("/services/vscommerce/api/ship-methods")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created shipMethod")
                .get("/services/vscommerce${new_shipMethod_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created shipMethod")
            .delete("/services/vscommerce${new_shipMethod_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
