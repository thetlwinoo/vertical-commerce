...
/**
 * Performance test for the AddressTypes entity.
 */
class AddressTypesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AddressTypes entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/address-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new addressTypes")
            .post("/services/vscommerce/api/address-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created addressTypes")
                .get("/services/vscommerce${new_addressTypes_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created addressTypes")
            .delete("/services/vscommerce${new_addressTypes_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
