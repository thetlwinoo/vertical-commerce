...
class BankAccountsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BankAccounts entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/bank-accounts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new bankAccounts")
            .post("/services/vscommerce/api/bank-accounts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_bankAccounts_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created bankAccounts")
            .delete("/services/vscommerce${new_bankAccounts_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
