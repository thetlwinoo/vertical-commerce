...
/**
 * Performance test for the ProductBrand entity.
 */
class ProductBrandGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProductBrand entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all productBrands")
            .get("/services/vscommerce/api/product-brands")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new productBrand")
            .post("/services/vscommerce/api/product-brands")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created productBrand")
                .get("/services/vscommerce${new_productBrand_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created productBrand")
            .delete("/services/vscommerce${new_productBrand_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
