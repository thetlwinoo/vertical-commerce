...
class DistrictsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Districts entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/districts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new districts")
            .post("/services/vscommerce/api/districts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_districts_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created districts")
            .delete("/services/vscommerce${new_districts_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
