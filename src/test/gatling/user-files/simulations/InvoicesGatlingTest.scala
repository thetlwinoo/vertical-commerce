...
class InvoicesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoices entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/invoices")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoices")
            .post("/services/vscommerce/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_invoices_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoices")
            .delete("/services/vscommerce${new_invoices_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
