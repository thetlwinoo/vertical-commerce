...
/**
 * Performance test for the BarcodeTypes entity.
 */
class BarcodeTypesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BarcodeTypes entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all barcodeTypes")
            .get("/services/vscommerce/api/barcode-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new barcodeTypes")
            .post("/services/vscommerce/api/barcode-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created barcodeTypes")
                .get("/services/vscommerce${new_barcodeTypes_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created barcodeTypes")
            .delete("/services/vscommerce${new_barcodeTypes_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
