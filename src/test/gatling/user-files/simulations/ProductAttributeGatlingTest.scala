...
class ProductAttributeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProductAttribute entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/product-attributes")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new productAttribute")
            .post("/services/vscommerce/api/product-attributes")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "value":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_productAttribute_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created productAttribute")
            .delete("/services/vscommerce${new_productAttribute_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
