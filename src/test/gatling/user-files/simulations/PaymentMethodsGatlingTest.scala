...
class PaymentMethodsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PaymentMethods entity")
        ...
        .repeat(2) {
            ...
            .get("/services/vscommerce/api/payment-methods")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new paymentMethods")
            .post("/services/vscommerce/api/payment-methods")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/vscommerce${new_paymentMethods_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created paymentMethods")
            .delete("/services/vscommerce${new_paymentMethods_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
