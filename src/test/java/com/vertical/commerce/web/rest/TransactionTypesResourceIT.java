...
import com.vertical.commerce.service.TransactionTypesService;
...
import com.vertical.commerce.service.TransactionTypesQueryService;
...
public class TransactionTypesResourceIT {
    ...
    public void updateTransactionTypes() throws Exception {
        ...
        restTransactionTypesMockMvc.perform(put("/api/transaction-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(transactionTypesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteTransactionTypes() throws Exception {
        ...
        restTransactionTypesMockMvc.perform(delete("/api/transaction-types/{id}", transactionTypes.getId()).with(csrf())
