...
import com.vertical.commerce.repository.ProductAttributeRepository;
import com.vertical.commerce.service.ProductAttributeService;
import com.vertical.commerce.service.dto.ProductAttributeDTO;
import com.vertical.commerce.service.mapper.ProductAttributeMapper;
import com.vertical.commerce.service.dto.ProductAttributeCriteria;
import com.vertical.commerce.service.ProductAttributeQueryService;
...
public class ProductAttributeResourceIT {
    ...
    public void createProductAttribute() throws Exception {
        ...
        restProductAttributeMockMvc.perform(post("/api/product-attributes").with(csrf())
    ...
    public void updateProductAttribute() throws Exception {
        ...
        restProductAttributeMockMvc.perform(put("/api/product-attributes").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(productAttributeDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteProductAttribute() throws Exception {
        ...
        restProductAttributeMockMvc.perform(delete("/api/product-attributes/{id}", productAttribute.getId()).with(csrf())
