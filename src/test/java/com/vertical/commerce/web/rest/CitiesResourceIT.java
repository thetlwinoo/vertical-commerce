...
import com.vertical.commerce.service.mapper.CitiesMapper;
import com.vertical.commerce.service.dto.CitiesCriteria;
import com.vertical.commerce.service.CitiesQueryService;
...
public class CitiesResourceIT {
    ...
    public void updateCities() throws Exception {
        ...
        restCitiesMockMvc.perform(put("/api/cities").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(citiesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCities() throws Exception {
        ...
        // Delete the cities
        restCitiesMockMvc.perform(delete("/api/cities/{id}", cities.getId()).with(csrf())
