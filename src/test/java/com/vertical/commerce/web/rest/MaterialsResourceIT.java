...
import com.vertical.commerce.repository.MaterialsRepository;
import com.vertical.commerce.service.MaterialsService;
import com.vertical.commerce.service.dto.MaterialsDTO;
import com.vertical.commerce.service.mapper.MaterialsMapper;
import com.vertical.commerce.service.dto.MaterialsCriteria;
import com.vertical.commerce.service.MaterialsQueryService;
...
public class MaterialsResourceIT {
    ...
    public void createMaterials() throws Exception {
        ...
        restMaterialsMockMvc.perform(post("/api/materials").with(csrf())
    ...
    public void deleteMaterials() throws Exception {
        ...
        restMaterialsMockMvc.perform(delete("/api/materials/{id}", materials.getId()).with(csrf())
