...
import com.vertical.commerce.service.dto.PeopleCriteria;
import com.vertical.commerce.service.PeopleQueryService;
...
public class PeopleResourceIT {
    ...
    private static final Boolean DEFAULT_EMAIL_PROMOTION = false;
    private static final Boolean UPDATED_EMAIL_PROMOTION = true;
    ...
    public void createPeople() throws Exception {
        ...
        assertThat(testPeople.getDateOfBirth()).isEqualTo(DEFAULT_DATE_OF_BIRTH);
        ...
        assertThat(testPeople.isEmailPromotion()).isEqualTo(DEFAULT_EMAIL_PROMOTION);
    ...
    public void getAllPeople() throws Exception {
        ...
        restPeopleMockMvc.perform(get("/api/people?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].emailPromotion").value(hasItem(DEFAULT_EMAIL_PROMOTION.booleanValue())))
    ...
    public void getPeople() throws Exception {
        ...
        restPeopleMockMvc.perform(get("/api/people/{id}", people.getId()))
            ...
            .andExpect(jsonPath("$.emailPromotion").value(DEFAULT_EMAIL_PROMOTION.booleanValue()))
    ...
    public void getAllPeopleByDateOfBirthIsEqualToSomething() throws Exception {
        ...
        // Get all the peopleList where dateOfBirth equals to DEFAULT_DATE_OF_BIRTH
        defaultPeopleShouldBeFound("dateOfBirth.equals=" + DEFAULT_DATE_OF_BIRTH);

        // Get all the peopleList where dateOfBirth equals to UPDATED_DATE_OF_BIRTH
        defaultPeopleShouldNotBeFound("dateOfBirth.equals=" + UPDATED_DATE_OF_BIRTH);
    }
    ...
    public void getAllPeopleByDateOfBirthIsNotEqualToSomething() throws Exception {
        ...
        // Get all the peopleList where dateOfBirth not equals to DEFAULT_DATE_OF_BIRTH
        defaultPeopleShouldNotBeFound("dateOfBirth.notEquals=" + DEFAULT_DATE_OF_BIRTH);

        // Get all the peopleList where dateOfBirth not equals to UPDATED_DATE_OF_BIRTH
        defaultPeopleShouldBeFound("dateOfBirth.notEquals=" + UPDATED_DATE_OF_BIRTH);
    }
    ...
    public void getAllPeopleByDateOfBirthIsInShouldWork() throws Exception {
        ...
        // Get all the peopleList where dateOfBirth in DEFAULT_DATE_OF_BIRTH or UPDATED_DATE_OF_BIRTH
        defaultPeopleShouldBeFound("dateOfBirth.in=" + DEFAULT_DATE_OF_BIRTH + "," + UPDATED_DATE_OF_BIRTH);

        // Get all the peopleList where dateOfBirth equals to UPDATED_DATE_OF_BIRTH
        defaultPeopleShouldNotBeFound("dateOfBirth.in=" + UPDATED_DATE_OF_BIRTH);
    }
    ...
    public void getAllPeopleByDateOfBirthIsNullOrNotNull() throws Exception {
        ...
        // Get all the peopleList where dateOfBirth is not null
        defaultPeopleShouldBeFound("dateOfBirth.specified=true");

        // Get all the peopleList where dateOfBirth is null
        defaultPeopleShouldNotBeFound("dateOfBirth.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllPeopleByUserIdIsEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId equals to DEFAULT_USER_ID
        defaultPeopleShouldBeFound("userId.equals=" + DEFAULT_USER_ID);

        // Get all the peopleList where userId equals to UPDATED_USER_ID
        defaultPeopleShouldNotBeFound("userId.equals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllPeopleByUserIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId not equals to DEFAULT_USER_ID
        defaultPeopleShouldNotBeFound("userId.notEquals=" + DEFAULT_USER_ID);

        // Get all the peopleList where userId not equals to UPDATED_USER_ID
        defaultPeopleShouldBeFound("userId.notEquals=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllPeopleByUserIdIsInShouldWork() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId in DEFAULT_USER_ID or UPDATED_USER_ID
        defaultPeopleShouldBeFound("userId.in=" + DEFAULT_USER_ID + "," + UPDATED_USER_ID);

        // Get all the peopleList where userId equals to UPDATED_USER_ID
        defaultPeopleShouldNotBeFound("userId.in=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllPeopleByUserIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId is not null
        defaultPeopleShouldBeFound("userId.specified=true");

        // Get all the peopleList where userId is null
        defaultPeopleShouldNotBeFound("userId.specified=false");
    }
                @Test
    @Transactional
    public void getAllPeopleByUserIdContainsSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId contains DEFAULT_USER_ID
        defaultPeopleShouldBeFound("userId.contains=" + DEFAULT_USER_ID);

        // Get all the peopleList where userId contains UPDATED_USER_ID
        defaultPeopleShouldNotBeFound("userId.contains=" + UPDATED_USER_ID);
    }

    @Test
    @Transactional
    public void getAllPeopleByUserIdNotContainsSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where userId does not contain DEFAULT_USER_ID
        defaultPeopleShouldNotBeFound("userId.doesNotContain=" + DEFAULT_USER_ID);

        // Get all the peopleList where userId does not contain UPDATED_USER_ID
        defaultPeopleShouldBeFound("userId.doesNotContain=" + UPDATED_USER_ID);
    }
    ...
    public void updatePeople() throws Exception {
        ...
        restPeopleMockMvc.perform(put("/api/people").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(peopleDTO)))
            .andExpect(status().isOk());
        ...
        assertThat(testPeople.getDateOfBirth()).isEqualTo(UPDATED_DATE_OF_BIRTH);
        ...
        assertThat(testPeople.isEmailPromotion()).isEqualTo(UPDATED_EMAIL_PROMOTION);
    ...
    public void deletePeople() throws Exception {
        ...
        // Delete the people
        restPeopleMockMvc.perform(delete("/api/people/{id}", people.getId()).with(csrf())
