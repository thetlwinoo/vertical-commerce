...
import com.vertical.commerce.service.mapper.InvoicesMapper;
import com.vertical.commerce.service.dto.InvoicesCriteria;
import com.vertical.commerce.service.InvoicesQueryService;
...
public class InvoicesResourceIT {
    ...
    public void createInvoices() throws Exception {
        ...
        restInvoicesMockMvc.perform(post("/api/invoices").with(csrf())
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoicesRepository.findAll().size();
        // set the field null
        invoices.setLastEditedWhen(null);
    ...
    public void getAllInvoicesByPaymentMethodIsEqualToSomething() throws Exception {
        ...
        // Get all the invoicesList where paymentMethod equals to paymentMethodId
        defaultInvoicesShouldBeFound("paymentMethodId.equals=" + paymentMethodId);

        // Get all the invoicesList where paymentMethod equals to paymentMethodId + 1
        defaultInvoicesShouldNotBeFound("paymentMethodId.equals=" + (paymentMethodId + 1));
    }
    ...
    public void updateInvoices() throws Exception {
        ...
        restInvoicesMockMvc.perform(put("/api/invoices").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(invoicesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteInvoices() throws Exception {
        ...
        // Delete the invoices
        restInvoicesMockMvc.perform(delete("/api/invoices/{id}", invoices.getId()).with(csrf())
