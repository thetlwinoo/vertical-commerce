...
import com.vertical.commerce.repository.CountriesRepository;
import com.vertical.commerce.service.CountriesService;
import com.vertical.commerce.service.dto.CountriesDTO;
import com.vertical.commerce.service.mapper.CountriesMapper;
import com.vertical.commerce.service.dto.CountriesCriteria;
import com.vertical.commerce.service.CountriesQueryService;
...
public class CountriesResourceIT {
    ...
    public void updateCountries() throws Exception {
        ...
        restCountriesMockMvc.perform(put("/api/countries").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(countriesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCountries() throws Exception {
        ...
        restCountriesMockMvc.perform(delete("/api/countries/{id}", countries.getId()).with(csrf())
