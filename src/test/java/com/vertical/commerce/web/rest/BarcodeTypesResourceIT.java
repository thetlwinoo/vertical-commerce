...
import com.vertical.commerce.repository.BarcodeTypesRepository;
import com.vertical.commerce.service.BarcodeTypesService;
import com.vertical.commerce.service.dto.BarcodeTypesDTO;
import com.vertical.commerce.service.mapper.BarcodeTypesMapper;
import com.vertical.commerce.service.dto.BarcodeTypesCriteria;
import com.vertical.commerce.service.BarcodeTypesQueryService;
...
public class BarcodeTypesResourceIT {
    ...
    public void createBarcodeTypes() throws Exception {
        ...
        restBarcodeTypesMockMvc.perform(post("/api/barcode-types").with(csrf())
    ...
    public void updateBarcodeTypes() throws Exception {
        ...
        restBarcodeTypesMockMvc.perform(put("/api/barcode-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(barcodeTypesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteBarcodeTypes() throws Exception {
        ...
        restBarcodeTypesMockMvc.perform(delete("/api/barcode-types/{id}", barcodeTypes.getId()).with(csrf())
