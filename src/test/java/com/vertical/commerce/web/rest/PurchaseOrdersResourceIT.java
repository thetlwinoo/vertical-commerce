...
import com.vertical.commerce.repository.PurchaseOrdersRepository;
import com.vertical.commerce.service.PurchaseOrdersService;
import com.vertical.commerce.service.dto.PurchaseOrdersDTO;
import com.vertical.commerce.service.mapper.PurchaseOrdersMapper;
import com.vertical.commerce.service.dto.PurchaseOrdersCriteria;
import com.vertical.commerce.service.PurchaseOrdersQueryService;
...
public class PurchaseOrdersResourceIT {
    ...
    public void createPurchaseOrders() throws Exception {
        ...
        restPurchaseOrdersMockMvc.perform(post("/api/purchase-orders").with(csrf())
    ...
    public void checkLastEditedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = purchaseOrdersRepository.findAll().size();
        // set the field null
        purchaseOrders.setLastEditedBy(null);
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = purchaseOrdersRepository.findAll().size();
        // set the field null
        purchaseOrders.setLastEditedWhen(null);
    ...
    public void updatePurchaseOrders() throws Exception {
        ...
        restPurchaseOrdersMockMvc.perform(put("/api/purchase-orders").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(purchaseOrdersDTO)))
            .andExpect(status().isOk());
    ...
    public void deletePurchaseOrders() throws Exception {
        ...
        restPurchaseOrdersMockMvc.perform(delete("/api/purchase-orders/{id}", purchaseOrders.getId()).with(csrf())
