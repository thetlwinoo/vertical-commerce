...
import com.vertical.commerce.repository.VehicleTemperaturesRepository;
import com.vertical.commerce.service.VehicleTemperaturesService;
import com.vertical.commerce.service.dto.VehicleTemperaturesDTO;
import com.vertical.commerce.service.mapper.VehicleTemperaturesMapper;
import com.vertical.commerce.service.dto.VehicleTemperaturesCriteria;
import com.vertical.commerce.service.VehicleTemperaturesQueryService;
...
public class VehicleTemperaturesResourceIT {
    ...
    public void createVehicleTemperatures() throws Exception {
        ...
        restVehicleTemperaturesMockMvc.perform(post("/api/vehicle-temperatures").with(csrf())
    ...
    public void updateVehicleTemperatures() throws Exception {
        ...
        restVehicleTemperaturesMockMvc.perform(put("/api/vehicle-temperatures").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(vehicleTemperaturesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteVehicleTemperatures() throws Exception {
        ...
        restVehicleTemperaturesMockMvc.perform(delete("/api/vehicle-temperatures/{id}", vehicleTemperatures.getId()).with(csrf())
