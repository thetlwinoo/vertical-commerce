...
import com.vertical.commerce.repository.SupplierCategoriesRepository;
import com.vertical.commerce.service.SupplierCategoriesService;
import com.vertical.commerce.service.dto.SupplierCategoriesDTO;
import com.vertical.commerce.service.mapper.SupplierCategoriesMapper;
import com.vertical.commerce.service.dto.SupplierCategoriesCriteria;
import com.vertical.commerce.service.SupplierCategoriesQueryService;
...
public class SupplierCategoriesResourceIT {
    ...
    public void updateSupplierCategories() throws Exception {
        ...
        restSupplierCategoriesMockMvc.perform(put("/api/supplier-categories").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(supplierCategoriesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteSupplierCategories() throws Exception {
        ...
        restSupplierCategoriesMockMvc.perform(delete("/api/supplier-categories/{id}", supplierCategories.getId()).with(csrf())
