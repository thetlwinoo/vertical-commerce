...
import com.vertical.commerce.repository.StockItemTransactionsRepository;
import com.vertical.commerce.service.StockItemTransactionsService;
import com.vertical.commerce.service.dto.StockItemTransactionsDTO;
import com.vertical.commerce.service.mapper.StockItemTransactionsMapper;
import com.vertical.commerce.service.dto.StockItemTransactionsCriteria;
import com.vertical.commerce.service.StockItemTransactionsQueryService;
...
public class StockItemTransactionsResourceIT {
    ...
    public void createStockItemTransactions() throws Exception {
        ...
        restStockItemTransactionsMockMvc.perform(post("/api/stock-item-transactions").with(csrf())
    ...
    public void checkLastEditedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = stockItemTransactionsRepository.findAll().size();
        // set the field null
        stockItemTransactions.setLastEditedBy(null);
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = stockItemTransactionsRepository.findAll().size();
        // set the field null
        stockItemTransactions.setLastEditedWhen(null);
    ...
    public void updateStockItemTransactions() throws Exception {
        ...
        restStockItemTransactionsMockMvc.perform(put("/api/stock-item-transactions").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(stockItemTransactionsDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteStockItemTransactions() throws Exception {
        ...
        restStockItemTransactionsMockMvc.perform(delete("/api/stock-item-transactions/{id}", stockItemTransactions.getId()).with(csrf())
