...
import com.vertical.commerce.repository.ProductAttributeSetRepository;
import com.vertical.commerce.service.ProductAttributeSetService;
import com.vertical.commerce.service.dto.ProductAttributeSetDTO;
import com.vertical.commerce.service.mapper.ProductAttributeSetMapper;
import com.vertical.commerce.service.dto.ProductAttributeSetCriteria;
import com.vertical.commerce.service.ProductAttributeSetQueryService;
...
public class ProductAttributeSetResourceIT {
    ...
    public void createProductAttributeSet() throws Exception {
        ...
        restProductAttributeSetMockMvc.perform(post("/api/product-attribute-sets").with(csrf())
    ...
    public void updateProductAttributeSet() throws Exception {
        ...
        restProductAttributeSetMockMvc.perform(put("/api/product-attribute-sets").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(productAttributeSetDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteProductAttributeSet() throws Exception {
        ...
        restProductAttributeSetMockMvc.perform(delete("/api/product-attribute-sets/{id}", productAttributeSet.getId()).with(csrf())
