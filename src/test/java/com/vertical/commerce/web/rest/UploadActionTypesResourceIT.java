...
import com.vertical.commerce.repository.UploadActionTypesRepository;
import com.vertical.commerce.service.UploadActionTypesService;
import com.vertical.commerce.service.dto.UploadActionTypesDTO;
import com.vertical.commerce.service.mapper.UploadActionTypesMapper;
import com.vertical.commerce.service.dto.UploadActionTypesCriteria;
import com.vertical.commerce.service.UploadActionTypesQueryService;
...
public class UploadActionTypesResourceIT {
    ...
    public void createUploadActionTypes() throws Exception {
        ...
        restUploadActionTypesMockMvc.perform(post("/api/upload-action-types").with(csrf())
    ...
    public void updateUploadActionTypes() throws Exception {
        ...
        restUploadActionTypesMockMvc.perform(put("/api/upload-action-types").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(uploadActionTypesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteUploadActionTypes() throws Exception {
        ...
        restUploadActionTypesMockMvc.perform(delete("/api/upload-action-types/{id}", uploadActionTypes.getId()).with(csrf())
