...
import com.vertical.commerce.repository.InvoiceLinesRepository;
import com.vertical.commerce.service.InvoiceLinesService;
import com.vertical.commerce.service.dto.InvoiceLinesDTO;
import com.vertical.commerce.service.mapper.InvoiceLinesMapper;
import com.vertical.commerce.service.dto.InvoiceLinesCriteria;
import com.vertical.commerce.service.InvoiceLinesQueryService;
...
public class InvoiceLinesResourceIT {
    ...
    public void createInvoiceLines() throws Exception {
        ...
        restInvoiceLinesMockMvc.perform(post("/api/invoice-lines").with(csrf())
    ...
    public void checkLastEditedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceLinesRepository.findAll().size();
        // set the field null
        invoiceLines.setLastEditedBy(null);
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = invoiceLinesRepository.findAll().size();
        // set the field null
        invoiceLines.setLastEditedWhen(null);
    ...
    public void updateInvoiceLines() throws Exception {
        ...
        restInvoiceLinesMockMvc.perform(put("/api/invoice-lines").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(invoiceLinesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteInvoiceLines() throws Exception {
        ...
        restInvoiceLinesMockMvc.perform(delete("/api/invoice-lines/{id}", invoiceLines.getId()).with(csrf())
