...
import com.vertical.commerce.repository.BuyingGroupsRepository;
import com.vertical.commerce.service.BuyingGroupsService;
import com.vertical.commerce.service.dto.BuyingGroupsDTO;
import com.vertical.commerce.service.mapper.BuyingGroupsMapper;
import com.vertical.commerce.service.dto.BuyingGroupsCriteria;
import com.vertical.commerce.service.BuyingGroupsQueryService;
...
public class BuyingGroupsResourceIT {
    ...
    public void updateBuyingGroups() throws Exception {
        ...
        restBuyingGroupsMockMvc.perform(put("/api/buying-groups").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(buyingGroupsDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteBuyingGroups() throws Exception {
        ...
        restBuyingGroupsMockMvc.perform(delete("/api/buying-groups/{id}", buyingGroups.getId()).with(csrf())
