...
import com.vertical.commerce.repository.ColdRoomTemperaturesRepository;
import com.vertical.commerce.service.ColdRoomTemperaturesService;
import com.vertical.commerce.service.dto.ColdRoomTemperaturesDTO;
import com.vertical.commerce.service.mapper.ColdRoomTemperaturesMapper;
import com.vertical.commerce.service.dto.ColdRoomTemperaturesCriteria;
import com.vertical.commerce.service.ColdRoomTemperaturesQueryService;
...
public class ColdRoomTemperaturesResourceIT {
    ...
    public void updateColdRoomTemperatures() throws Exception {
        ...
        restColdRoomTemperaturesMockMvc.perform(put("/api/cold-room-temperatures").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(coldRoomTemperaturesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteColdRoomTemperatures() throws Exception {
        ...
        restColdRoomTemperaturesMockMvc.perform(delete("/api/cold-room-temperatures/{id}", coldRoomTemperatures.getId()).with(csrf())
