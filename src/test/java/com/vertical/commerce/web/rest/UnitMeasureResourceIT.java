...
import com.vertical.commerce.repository.UnitMeasureRepository;
import com.vertical.commerce.service.UnitMeasureService;
import com.vertical.commerce.service.dto.UnitMeasureDTO;
import com.vertical.commerce.service.mapper.UnitMeasureMapper;
import com.vertical.commerce.service.dto.UnitMeasureCriteria;
import com.vertical.commerce.service.UnitMeasureQueryService;
...
public class UnitMeasureResourceIT {
    ...
    public void createUnitMeasure() throws Exception {
        ...
        restUnitMeasureMockMvc.perform(post("/api/unit-measures").with(csrf())
    ...
    public void updateUnitMeasure() throws Exception {
        ...
        restUnitMeasureMockMvc.perform(put("/api/unit-measures").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(unitMeasureDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteUnitMeasure() throws Exception {
        ...
        restUnitMeasureMockMvc.perform(delete("/api/unit-measures/{id}", unitMeasure.getId()).with(csrf())
