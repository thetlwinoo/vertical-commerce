...
import com.vertical.commerce.repository.SystemParametersRepository;
import com.vertical.commerce.service.SystemParametersService;
import com.vertical.commerce.service.dto.SystemParametersDTO;
import com.vertical.commerce.service.mapper.SystemParametersMapper;
import com.vertical.commerce.service.dto.SystemParametersCriteria;
import com.vertical.commerce.service.SystemParametersQueryService;
...
public class SystemParametersResourceIT {
    ...
    public void createSystemParameters() throws Exception {
        ...
        restSystemParametersMockMvc.perform(post("/api/system-parameters").with(csrf())
    ...
    public void updateSystemParameters() throws Exception {
        ...
        restSystemParametersMockMvc.perform(put("/api/system-parameters").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(systemParametersDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteSystemParameters() throws Exception {
        ...
        restSystemParametersMockMvc.perform(delete("/api/system-parameters/{id}", systemParameters.getId()).with(csrf())
