...
import com.vertical.commerce.repository.ProductOptionRepository;
import com.vertical.commerce.service.ProductOptionService;
import com.vertical.commerce.service.dto.ProductOptionDTO;
import com.vertical.commerce.service.mapper.ProductOptionMapper;
import com.vertical.commerce.service.dto.ProductOptionCriteria;
import com.vertical.commerce.service.ProductOptionQueryService;
...
public class ProductOptionResourceIT {
    ...
    public void createProductOption() throws Exception {
        ...
        restProductOptionMockMvc.perform(post("/api/product-options").with(csrf())
    ...
    public void updateProductOption() throws Exception {
        ...
        restProductOptionMockMvc.perform(put("/api/product-options").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(productOptionDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteProductOption() throws Exception {
        ...
        restProductOptionMockMvc.perform(delete("/api/product-options/{id}", productOption.getId()).with(csrf())
