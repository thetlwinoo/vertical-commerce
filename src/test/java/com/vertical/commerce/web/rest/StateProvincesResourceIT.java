...
import com.vertical.commerce.repository.StateProvincesRepository;
import com.vertical.commerce.service.StateProvincesService;
import com.vertical.commerce.service.dto.StateProvincesDTO;
import com.vertical.commerce.service.mapper.StateProvincesMapper;
import com.vertical.commerce.service.dto.StateProvincesCriteria;
import com.vertical.commerce.service.StateProvincesQueryService;
...
public class StateProvincesResourceIT {
    ...
    public void updateStateProvinces() throws Exception {
        ...
        restStateProvincesMockMvc.perform(put("/api/state-provinces").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(stateProvincesDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteStateProvinces() throws Exception {
        ...
        restStateProvincesMockMvc.perform(delete("/api/state-provinces/{id}", stateProvinces.getId()).with(csrf())
