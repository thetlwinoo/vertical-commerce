...
import com.vertical.commerce.repository.CurrencyRateRepository;
import com.vertical.commerce.service.CurrencyRateService;
import com.vertical.commerce.service.dto.CurrencyRateDTO;
import com.vertical.commerce.service.mapper.CurrencyRateMapper;
import com.vertical.commerce.service.dto.CurrencyRateCriteria;
import com.vertical.commerce.service.CurrencyRateQueryService;
...
public class CurrencyRateResourceIT {
    ...
    public void createCurrencyRate() throws Exception {
        ...
        restCurrencyRateMockMvc.perform(post("/api/currency-rates").with(csrf())
    ...
    public void checkLastEditedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = currencyRateRepository.findAll().size();
        // set the field null
        currencyRate.setLastEditedBy(null);
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = currencyRateRepository.findAll().size();
        // set the field null
        currencyRate.setLastEditedWhen(null);
    ...
    public void updateCurrencyRate() throws Exception {
        ...
        restCurrencyRateMockMvc.perform(put("/api/currency-rates").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(currencyRateDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCurrencyRate() throws Exception {
        ...
        restCurrencyRateMockMvc.perform(delete("/api/currency-rates/{id}", currencyRate.getId()).with(csrf())
