...
import com.vertical.commerce.repository.PurchaseOrderLinesRepository;
import com.vertical.commerce.service.PurchaseOrderLinesService;
import com.vertical.commerce.service.dto.PurchaseOrderLinesDTO;
import com.vertical.commerce.service.mapper.PurchaseOrderLinesMapper;
import com.vertical.commerce.service.dto.PurchaseOrderLinesCriteria;
import com.vertical.commerce.service.PurchaseOrderLinesQueryService;
...
public class PurchaseOrderLinesResourceIT {
    ...
    public void createPurchaseOrderLines() throws Exception {
        ...
        restPurchaseOrderLinesMockMvc.perform(post("/api/purchase-order-lines").with(csrf())
    ...
    public void checkLastEditedByIsRequired() throws Exception {
        int databaseSizeBeforeTest = purchaseOrderLinesRepository.findAll().size();
        // set the field null
        purchaseOrderLines.setLastEditedBy(null);
    ...
    public void checkLastEditedWhenIsRequired() throws Exception {
        int databaseSizeBeforeTest = purchaseOrderLinesRepository.findAll().size();
        // set the field null
        purchaseOrderLines.setLastEditedWhen(null);
    ...
    public void updatePurchaseOrderLines() throws Exception {
        ...
        restPurchaseOrderLinesMockMvc.perform(put("/api/purchase-order-lines").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(purchaseOrderLinesDTO)))
            .andExpect(status().isOk());
    ...
    public void deletePurchaseOrderLines() throws Exception {
        ...
        restPurchaseOrderLinesMockMvc.perform(delete("/api/purchase-order-lines/{id}", purchaseOrderLines.getId()).with(csrf())
