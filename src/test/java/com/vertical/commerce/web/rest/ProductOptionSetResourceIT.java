...
import com.vertical.commerce.repository.ProductOptionSetRepository;
import com.vertical.commerce.service.ProductOptionSetService;
import com.vertical.commerce.service.dto.ProductOptionSetDTO;
import com.vertical.commerce.service.mapper.ProductOptionSetMapper;
import com.vertical.commerce.service.dto.ProductOptionSetCriteria;
import com.vertical.commerce.service.ProductOptionSetQueryService;
...
public class ProductOptionSetResourceIT {
    ...
    public void createProductOptionSet() throws Exception {
        ...
        restProductOptionSetMockMvc.perform(post("/api/product-option-sets").with(csrf())
    ...
    public void updateProductOptionSet() throws Exception {
        ...
        restProductOptionSetMockMvc.perform(put("/api/product-option-sets").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(productOptionSetDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteProductOptionSet() throws Exception {
        ...
        restProductOptionSetMockMvc.perform(delete("/api/product-option-sets/{id}", productOptionSet.getId()).with(csrf())
