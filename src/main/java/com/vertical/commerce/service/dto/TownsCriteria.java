...
/**
 * Criteria class for the {@link com.vertical.commerce.domain.Towns} entity. This class is used
 * in {@link com.vertical.commerce.web.rest.TownsResource} to receive all the possible filtering options from
 ...
 */
public class TownsCriteria implements Serializable, Criteria {
    ...
    public TownsCriteria() {
    }

    public TownsCriteria(TownsCriteria other) {
    ...
    @Override
    public TownsCriteria copy() {
        return new TownsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TownsCriteria that = (TownsCriteria) o;
        return
