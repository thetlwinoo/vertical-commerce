...
/**
 * A DTO for the {@link com.vertical.commerce.domain.ProductDocument} entity.
 */
public class ProductDocumentDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductDocumentDTO)) {
            return false;
        }

        return id != null && id.equals(((ProductDocumentDTO) o).id);
    }
