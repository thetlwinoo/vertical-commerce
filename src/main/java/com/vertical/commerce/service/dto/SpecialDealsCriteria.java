...
/**
 * Criteria class for the {@link com.vertical.commerce.domain.SpecialDeals} entity. This class is used
 * in {@link com.vertical.commerce.web.rest.SpecialDealsResource} to receive all the possible filtering options from
...
public class SpecialDealsCriteria implements Serializable, Criteria {
    ...
    public LongFilter getCartListId() {
        return cartListId;
    }

    public void setCartListId(LongFilter cartListId) {
        this.cartListId = cartListId;
    }

    public LongFilter getOrderListId() {
        return orderListId;
    }

    public void setOrderListId(LongFilter orderListId) {
