...
/**
 * Criteria class for the {@link com.vertical.commerce.domain.ProductDocuments} entity. This class is used
 * in {@link com.vertical.commerce.web.rest.ProductDocumentsResource} to receive all the possible filtering options from
 ...
 */
public class ProductDocumentsCriteria implements Serializable, Criteria {
    ...
    public ProductDocumentsCriteria(ProductDocumentsCriteria other) {
    ...
    @Override
    public ProductDocumentsCriteria copy() {
        return new ProductDocumentsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductDocumentsCriteria that = (ProductDocumentsCriteria) o;
        return
    ...
    public String toString() {
        return "ProductDocumentsCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
