...
/**
 * A DTO for the {@link com.vertical.commerce.domain.TownshipsCulture} entity.
 */
public class TownshipsCultureDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TownshipsCultureDTO)) {
            return false;
        }

        return id != null && id.equals(((TownshipsCultureDTO) o).id);
    }
