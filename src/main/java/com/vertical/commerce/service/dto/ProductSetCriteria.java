...
/**
 * Criteria class for the {@link com.vertical.commerce.domain.ProductSet} entity. This class is used
 * in {@link com.vertical.commerce.web.rest.ProductSetResource} to receive all the possible filtering options from
...
public class ProductSetCriteria implements Serializable, Criteria {
    ...
    private InstantFilter modifinedDate;
    ...
    public ProductSetCriteria(ProductSetCriteria other) {
        ...
        this.modifinedDate = other.modifinedDate == null ? null : other.modifinedDate.copy();
    }
    ...
    public InstantFilter getModifinedDate() {
        return modifinedDate;
    }

    public void setModifinedDate(InstantFilter modifinedDate) {
    ...
    public boolean equals(Object o) {
        ...
        return
            ...
            Objects.equals(modifinedDate, that.modifinedDate);
    }
    ...
    public String toString() {
        return "ProductSetCriteria{" +
                ...
                (modifinedDate != null ? "modifinedDate=" + modifinedDate + ", " : "") +
            "}";
    }
