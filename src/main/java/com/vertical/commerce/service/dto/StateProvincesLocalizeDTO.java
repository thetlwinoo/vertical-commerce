...
/**
 * A DTO for the {@link com.vertical.commerce.domain.StateProvincesLocalize} entity.
 */
public class StateProvincesLocalizeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StateProvincesLocalizeDTO)) {
            return false;
        }

        return id != null && id.equals(((StateProvincesLocalizeDTO) o).id);
    }
    ...
    public String toString() {
        return "StateProvincesLocalizeDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
