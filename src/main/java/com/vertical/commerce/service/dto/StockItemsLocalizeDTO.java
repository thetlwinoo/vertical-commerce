...
/**
 * A DTO for the {@link com.vertical.commerce.domain.StockItemsLocalize} entity.
 */
public class StockItemsLocalizeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StockItemsLocalizeDTO)) {
            return false;
        }

        return id != null && id.equals(((StockItemsLocalizeDTO) o).id);
    }
