...
/**
 * Service Interface for managing {@link com.vertical.commerce.domain.Products}.
 */
public interface ProductsService {
    ...
    /**
     * Get all the ProductsDTO where ProductDocument is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<ProductsDTO> findAllWhereProductDocumentIsNull();
