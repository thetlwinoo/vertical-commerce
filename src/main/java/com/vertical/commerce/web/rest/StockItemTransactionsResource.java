...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.StockItemTransactions}.
 */
@RestController
@RequestMapping("/api")
public class StockItemTransactionsResource {
    ...
    private static final String ENTITY_NAME = "vscommerceStockItemTransactions";
