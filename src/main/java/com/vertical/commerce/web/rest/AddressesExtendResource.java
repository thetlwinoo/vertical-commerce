...
public class AddressesExtendResource {
    ...
    public ResponseEntity<AddressesDTO> createAddresses(@Valid @RequestBody AddressesDTO addressesDTO, Principal principal) throws URISyntaxException {
        ...
        AddressesDTO result = addressesExtendService.crateAddresses(addressesDTO, principal);
    ...
    public ResponseEntity<AddressesDTO> updateAddresses(@Valid @RequestBody AddressesDTO addressesDTO, Principal principal) throws URISyntaxException {
        ...
        AddressesDTO result = addressesExtendService.updateAddresses(addressesDTO, principal);
    ...
    public ResponseEntity<AddressesDTO> setDefaultAddress(@Valid @RequestBody Long id, Principal principal) throws URISyntaxException {
        addressesExtendService.setDefaultAddress(id, principal);
