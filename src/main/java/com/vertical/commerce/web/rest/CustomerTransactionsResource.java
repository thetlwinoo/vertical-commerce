...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.CustomerTransactions}.
 */
@RestController
@RequestMapping("/api")
public class CustomerTransactionsResource {
    ...
    private static final String ENTITY_NAME = "vscommerceCustomerTransactions";
