...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.VehicleTemperatures}.
 */
@RestController
@RequestMapping("/api")
public class VehicleTemperaturesResource {
    ...
    private static final String ENTITY_NAME = "vscommerceVehicleTemperatures";
