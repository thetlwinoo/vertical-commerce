...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.SupplierTransactions}.
 */
@RestController
@RequestMapping("/api")
public class SupplierTransactionsResource {
    ...
    private static final String ENTITY_NAME = "vscommerceSupplierTransactions";
