...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.BusinessEntityContact}.
 */
@RestController
@RequestMapping("/api")
public class BusinessEntityContactResource {
    ...
    private static final String ENTITY_NAME = "vscommerceBusinessEntityContact";
