...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.ColdRoomTemperatures}.
 */
@RestController
@RequestMapping("/api")
public class ColdRoomTemperaturesResource {
    ...
    private static final String ENTITY_NAME = "vscommerceColdRoomTemperatures";
