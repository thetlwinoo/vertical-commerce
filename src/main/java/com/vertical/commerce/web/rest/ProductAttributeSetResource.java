...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.ProductAttributeSet}.
 */
@RestController
@RequestMapping("/api")
public class ProductAttributeSetResource {
    ...
    private static final String ENTITY_NAME = "vscommerceProductAttributeSet";
