...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.ShoppingCartItems}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartItemsResource {
    ...
    private static final String ENTITY_NAME = "vscommerceShoppingCartItems";
    ...
    public ResponseEntity<ShoppingCartItemsDTO> createShoppingCartItems(@Valid @RequestBody ShoppingCartItemsDTO shoppingCartItemsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ShoppingCartItemsDTO> updateShoppingCartItems(@Valid @RequestBody ShoppingCartItemsDTO shoppingCartItemsDTO) throws URISyntaxException {
