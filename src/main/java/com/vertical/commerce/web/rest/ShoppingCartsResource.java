...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.ShoppingCarts}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartsResource {
    ...
    private static final String ENTITY_NAME = "vscommerceShoppingCarts";
    ...
    public ResponseEntity<ShoppingCartsDTO> createShoppingCarts(@Valid @RequestBody ShoppingCartsDTO shoppingCartsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ShoppingCartsDTO> updateShoppingCarts(@Valid @RequestBody ShoppingCartsDTO shoppingCartsDTO) throws URISyntaxException {
