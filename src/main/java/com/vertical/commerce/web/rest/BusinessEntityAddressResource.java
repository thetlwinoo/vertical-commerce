...
/**
 * REST controller for managing {@link com.vertical.commerce.domain.BusinessEntityAddress}.
 */
@RestController
@RequestMapping("/api")
public class BusinessEntityAddressResource {
    ...
    private static final String ENTITY_NAME = "vscommerceBusinessEntityAddress";
