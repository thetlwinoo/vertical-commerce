...
public class SupplierTransactions implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "supplierTransactions", allowSetters = true)
    ...
    public SupplierTransactions order(Orders orders) {
        this.order = orders;
        return this;
    }
    ...
    public SupplierTransactions invoice(Invoices invoices) {
    ...
    public SupplierTransactionStatus getStatus() {
        return status;
    }

    public SupplierTransactions status(SupplierTransactionStatus supplierTransactionStatus) {
        this.status = supplierTransactionStatus;
        return this;
    }

    public void setStatus(SupplierTransactionStatus supplierTransactionStatus) {
        this.status = supplierTransactionStatus;
    }
